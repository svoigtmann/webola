 ...
 * Starter/Teams können mit dem Suchfeld unten rechts gesucht wurden. Bei Auswahl des Starters/Teams springt **webola** zur entsprechenden Registerkarte. Wenn bei leerem Suchfeld einfach Return gedrückt wird, kann der Fokus des Eingabefeldes zurückgesetzt werden. Das ist wichtig, damit z.B. die Markierungen der gelaufenen Runden wieder gesetzt werden können.
